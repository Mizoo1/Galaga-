 ...
 *            nahmed@stud.hs-bremen.de, Nour
 * @createdOn 18.01.2023
 * @version   1.0.0
 * @brief     This class implements the SoundMenu of the Galaga game
 *            It has methods to display and update the settings of the game
 *========================================================================**/
using System;
        ...
        **/
        ...
        private void UpdateButtonPositions()
        {
            ...
            if (mouseX >= _music_onRect.x && mouseX <= _music_onRect.x + _music_onRect.w &&
                mouseY >= _music_onRect.y && mouseY <= _music_onRect.y + _music_onRect.h && _music_onRect.x > 370)
            {
                // Move the button to the left
                _music_onRect.x -= 1;
            }
            // Check if the button is not at its original position
            else if (_music_onRect.x < 400)
            {
            ...
            if (mouseX >= _music_offRect.x && mouseX <= _music_offRect.x + _music_offRect.w &&
                mouseY >= _music_offRect.y && mouseY <= _music_offRect.y + _music_offRect.h && _music_offRect.x > 370)
            {
                _music_offRect.x -= 1;
            }
            else if (_music_offRect.x < 400)
            {
                _music_offRect.x += 1;
            }
